...
class Cluster{
    ...
    public:
        ...
        bool update_values(){
            if(this->x_coordinate == x_coordinate_total / this->number_of_dots && this->y_coordinate == y_coordinate_total / this->number_of_dots){
                return false;
            }
            this->x_coordinate = x_coordinate_total/this->number_of_dots;
            this->y_coordinate = y_coordinate_total/this->number_of_dots;
            return true;
        }
};